...
let res5 = [];
let callBack5 = item => res5.push(item);
...
let res6 = [];
ar5.forEach(item => res6.push(item)); // сюда в скобки дописываете стрелочную функцию
...
let res7;
let callBack7 = item => item > 10 ? true : false;
...
let res9;
let callBack9 = item => item > 10 ? true : false
...
let res10;
res10 = ar9.some(item => item > 10 ? true : false);// сюда в скобки дописываете стрелочную функцию
