...
function t3(min, max) {
    let randomNum = Math.floor(min + Math.random() * (max - min));
    document.querySelector('.out-3').textContent = randomNum;
}
...
function t4(a, b, c) {
    if (b !== 0) {
        document.querySelector('.out-4').textContent = a / b;
    } else {
...
function t5(a, b, c = 0) {
    if (b !== 0) {
        document.querySelector('.out-5').textContent = a / b;
    } else {
...
function t10() {
    let num = [...arguments];
    document.querySelector('.out-10').textContent = num.length;
...
function t11() {
    let num = [...arguments];
    let sum = num.reduce((initV, curV) => initV + curV, 0);
    document.querySelector('.out-11').textContent = sum;
