...
function t1(min, max) {
    let randomNum = Math.floor(min + Math.random() * (1 + max - min));
    document.querySelector('.out-1').textContent = randomNum.toString();
}
...
function t3(min, max) {
    let randomNum = Math.floor(min + Math.random() * (max - min));
    document.querySelector('.out-3').textContent = randomNum.toString();
}
...
function t4(a, b, c) {
    if (b !== 0) {
        document.querySelector('.out-4').textContent = (a / b).toString();
    }
    else {
        document.querySelector('.out-4').textContent = c.toString();
    }
}
...
function t5(a, b, c = 0) {
    if (b !== 0) {
        document.querySelector('.out-5').textContent = (a / b).toString();
    }
    else {
        document.querySelector('.out-5').textContent = c === 0 ? c.toString() : c.toString();
    }
}
...
function t11(...args) {
    let sum = args.reduce((initV, curV) => initV + curV, 0);
    document.querySelector('.out-11').textContent = sum.toString();
}
...
function t12(...args) {
    let sum = args.reduce((initV, curV) => initV + curV, 0);
    document.querySelector('.out-12').textContent = sum.toString();
}
