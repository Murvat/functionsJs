...
const t15 = (input) => (typeof input === "number" ? true : false);
...
const t16 = (num) => num.length % 2 === 0 ? true : false;
...
const t17 = (arr) => {
    let res = arr.reduce((acc, init) => acc + init, 0);//если все значения числа то и сумма будет числом
